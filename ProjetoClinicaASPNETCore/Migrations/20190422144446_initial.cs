        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VeterinarioId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    VetNome = table.Column<string>(nullable: true),
                    VetEndereco = table.Column<string>(nullable: true),
                    VetTelefone = table.Column<string>(nullable: true),
                    VetFuncao = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Animais_AspNetUsers_UserId",
                        column: x => x.UserId,
